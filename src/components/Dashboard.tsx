          ...
          {files
            ...
            .map((file) => (
              ...
              >
                ...
                >
                  <div className="py-4 px-6 flex w-full items-center justify-between space-x-4">
                ...
                <div className="px-6 my-2 grid grid-cols-3 place-items-center py-2 gap-6 text-xs text-zinc-500">
